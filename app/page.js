...
export default async function Home() {
  ...
  return (
    <>
      <div className="fixed z-0 right-0 bg-[url('/treeclimber_green.png')] min-h-screen w-[633px] bg-opacity-40 bg-no-repeat bg-right" />
        ...
        <div className="relative z-10 min-h-screen grid grid-flow-row max-w-4xl w-full mx-auto ">
          <section className="self-end">
            ...
            <p className="leading-relaxed text-lg paddingX">
              Jeg elsker trær, men noen ganger må de fjernes eller beskjæres og
              da gjør jeg gjerne jobben for deg. Står treet vanskelig til kan
              jeg klatre opp og felle det bit for bit, og vil du at jeg kjører
              alt bort ordner jeg det også. Kanskje du vil ha ved istedenfor
              tre? Da kan jeg kløyve og stable det opp til tørk. Hvis du er så
              heldig å ha trær som egner seg til å lage noen unike bordplater
              eller annet interiør av, tar jeg gjerne en kreativ prat om det.
            </p>
          </section>
